...
def list_registry_items(
    ...
    GET /api/method/websitecms.api.registry.list_registry_items
    """
...
def get_registry_item(name: str) -> dict[str, Any]:
    ...
    GET /api/method/websitecms.api.registry.get_registry_item
    """
    if not name:
...
def search_registry(
    ...
    GET /api/method/websitecms.api.registry.search_registry
    """
