...
def get_published_environments(limit=10, fields=None):
	...
	Example:
		GET/POST /api/method/senaerp_platform.api.website_environment.get_published_environments
		Payload: {"limit": 10}
	"""
	try:
...
def get_environment_by_id(environment_id):
	...
	Example:
		GET/POST /api/method/senaerp_platform.api.website_environment.get_environment_by_id
...
def get_environment_count():
	...
	Example:
		GET/POST /api/method/senaerp_platform.api.website_environment.get_environment_count
	"""
	try:
