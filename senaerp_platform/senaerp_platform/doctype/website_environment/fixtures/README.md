...
Example:
```bash
bench --site senamarketing.senaerp.com execute senaerp_platform.senaerp_platform.doctype.website_environment.fixtures.load_fixtures.load_all_fixtures
```
...
Then in the console:
```python
from senaerp_platform.senaerp_platform.doctype.website_environment.fixtures.load_fixtures import load_all_fixtures
load_all_fixtures()
```
...
curl https://senamarketing.senaerp.com/api/method/senaerp_platform.api.website_environment.get_environment_by_id?environment_id=travel-agencies

# Get count
curl https://senamarketing.senaerp.com/api/method/senaerp_platform.api.website_environment.get_environment_count
```
